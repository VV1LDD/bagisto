...
@endif
    ...
    <div class="flex-auto ios-tile-relative ios-group max-w-[600px] mx-auto p-8 max-md:p-6">
        <button type="button" onclick="window.location='{{ route('shop.customers.account.organizations.index') }}'"
            class="ios-back-button">
            <span class="icon-arrow-left text-xl"></span>
        </button>

        <button type="button"
            onclick="window.location='{{ route('shop.customers.account.organizations.index') }}'"
